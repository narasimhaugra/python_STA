...
def EEA_Adapter_1W_SC_Before_Entering_Firemode(json_data, NCDComPort,
    ...
    EEA_Adapter_1W_Short_Circuit_Before_Entering_Firemode(serialControlObj, videoPath, itr, passed_executions,
                                                          PowerPackComPort, NCDComPort)
    serialControlObj.disconnectSerialConnection()


# Purpose-To perform Normal Firing Scenarios
def EEA_Adapter_1W_Short_Circuit_Before_Entering_Firemode(serialControlObj, videoPath, itr,
    ...
    for i in range(total_firings):
        ...
        # Firing Test
        serialControlObj.adapter_1w_SC_before_firing(clampingForce=clampingForce, firingForce=firingForce,
