...
def EEA_Random_Key_Presses_during_Firing (r, SULU_EEPROM_command_byte, MULU_EEPROM_command_byte, CARTRIDGE_EEPROM_command_byte, NCDComPort,
    ...
    EEA_Random_Key_Presses_during_Total_Firing(serialControlObj, EEA_RELOAD_EEPROM_command_byte, NCDComPort,
...
def EEA_Random_Key_Presses_during_Total_Firing(serialControlObj, EEA_RELOAD_EEPROM_command_byte, NCDComPort,
                 PowerPackComPort, BlackBoxComPort, USB6351ComPort, ArduinoUNOComPort, OUTPUT_PATH, videoPath, p):
...
# MCPThread.readingPowerPack.exitFlag = True
    ...
    if serialControlObj.r['Reload Type'] == "EEA":
        ...
        # Random key presses during firing
        ...
        # End of Random key presses during firing
