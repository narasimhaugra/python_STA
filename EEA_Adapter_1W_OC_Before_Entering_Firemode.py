...
def EEA_Adapter_1W_OC_Before_Entering_Firemode(json_data, NCDComPort,
    ...
    EEA_Adapter_1W_Open_Circuit_Before_Entering_Firemode(serialControlObj, videoPath, itr,
...
def EEA_Adapter_1W_Open_Circuit_Before_Entering_Firemode(serialControlObj, videoPath, itr,
                                                         passed_executions, PowerPackComPort, NCDComPort):
    success_flag = True
    ...
    for i in range(total_firings):
        ...
        # Firing Test
        serialControlObj.adapter_1w_OC_before_firing(clampingForce=clampingForce, firingForce=firingForce,
