...
def EEA_Adapter_1W_OC_After_Entering_Fire_Mode(json_data, NCDComPort,
    ...
    EEA_Adapter_1W_Open_Circuit_After_Entering_Fire_Mode(serialControlObj, videoPath, itr, passed_executions,
                                                         PowerPackComPort, NCDComPort)
    serialControlObj.disconnectSerialConnection()


# Purpose-To perform Normal Firing Scenarios
def EEA_Adapter_1W_Open_Circuit_After_Entering_Fire_Mode(serialControlObj, videoPath, itr,
    ...
    for i in range(total_firings):
        ...
        # Firing Test
        serialControlObj.adapter_1w_OC_after_firing(clampingForce=clampingForce, firingForce=firingForce,
