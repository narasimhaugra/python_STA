...
Purpose: Clamshell 1W Open circuit error during Firing"""
...
def Clamshell_1W_OC_in_Fire_Mode(r, SULU_EEPROM_command_byte, MULU_EEPROM_command_byte, CARTRIDGE_EEPROM_command_byte,
                               NCDComPort,
    ...
    print('Clamshell 1W Open Circuit in Fire Mode') #, r, SULU_EEPROM_command_byte, MULU_EEPROM_command_byte,      CARTRIDGE_EEPROM_command_byte)
    ...
    Clamshell_1W_Open_Circuit_in_Fire_Mode(serialControlObj, SULU_EEPROM_command_byte, MULU_EEPROM_command_byte, CARTRIDGE_EEPROM_command_byte,
                               NCDComPort,
                               PowerPackComPort, BlackBoxComPort, USB6351ComPort, ArduinoUNOComPort, OUTPUT_PATH,
                               videoPath, p)
    # time.sleep(5)
...
def Clamshell_1W_Open_Circuit_in_Fire_Mode(serialControlObj, SULU_EEPROM_command_byte, MULU_EEPROM_command_byte, CARTRIDGE_EEPROM_command_byte,
                               NCDComPort,
                               PowerPackComPort, BlackBoxComPort, USB6351ComPort, ArduinoUNOComPort, OUTPUT_PATH,
                               videoPath, p):
    ...
    for i in range(serialControlObj.r['Num of Firings in Procedure']):
        ...
        print("Disconnecting Clamshell 1Wire")
