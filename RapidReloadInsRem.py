#'''Rapid Reload Ins Rem completely re-written by Manoj vadali 21-Jan -2022'''#
...
def RapidReloadInsRem(r, SULU_EEPROM_command_byte, MULU_EEPROM_command_byte, CARTRIDGE_EEPROM_command_byte, NCDComPort,
    ...
    Rapid_Reload_Ins_Rem(serialControlObj, SULU_EEPROM_command_byte, MULU_EEPROM_command_byte, CARTRIDGE_EEPROM_command_byte, NCDComPort,
                 PowerPackComPort, BlackBoxComPort, USB6351ComPort, ArduinoUNOComPort, OUTPUT_PATH, videoPath,p)
...
def Rapid_Reload_Ins_Rem(serialControlObj, SULU_EEPROM_command_byte, MULU_EEPROM_command_byte, CARTRIDGE_EEPROM_command_byte, NCDComPort,
                 PowerPackComPort, BlackBoxComPort, USB6351ComPort, ArduinoUNOComPort, OUTPUT_PATH, videoPath,p):
...
# commented by Vadali on 3rd March after testing, need to test and confirm the change
            # videoThread = OLEDRecordingThread.myThread(
