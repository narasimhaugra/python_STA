...
def EEAFiringStaplingRecovery(json_data, NCDComPort,
    ...
    EEA_Firing_Stapling_Recovery(serialControlObj, videoPath, itr, passed_executions, PowerPackComPort, NCDComPort)
    serialControlObj.disconnectSerialConnection()


# Purpose-To perform Normal Firing Scenarios
def EEA_Firing_Stapling_Recovery(serialControlObj, videoPath, itr, passed_executions, PowerPackComPort, NCDComPort):
    success_flag = True
    ...
    # Stapling Recovery - Negative Case
    if "Stapling Recovery No Staple Exit State" == scenario_name:
