...
def EEA_Clamshell_1W_SC_Before_Entering_Firemode(json_data, NCDComPort,
    ...
    EEA_Clamshell_1W_Short_Circuit_Before_Entering_Firemode(serialControlObj, videoPath, itr,
...
def EEA_Clamshell_1W_Short_Circuit_Before_Entering_Firemode(serialControlObj, videoPath, itr,
                                                            passed_executions,  PowerPackComPort, NCDComPort):
    success_flag = True
    ...
    for i in range(total_firings):
        ...
        # Firing Test
        serialControlObj.clamshell_1w_SC_before_firing(clampingForce=clampingForce, firingForce=firingForce,
