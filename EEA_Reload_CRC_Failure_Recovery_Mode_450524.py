...
def EEADVRecoveryMode_450524(json_data, NCDComPort,
    ...
    EEA_DV_Recovery_Mode_450524(serialControlObj, videoPath, itr, passed_executions, PowerPackComPort, NCDComPort)
    serialControlObj.disconnectSerialConnection()


# Purpose-To perform Normal Firing Scenarios
def EEA_DV_Recovery_Mode_450524(serialControlObj, videoPath, itr, passed_executions, PowerPackComPort, NCDComPort):
    success_flag = True
    ...
    for i in range(total_firings):
        ...
        # Firing Test
        serialControlObj.DV_firing_450524(clampingForce=clampingForce, firingForce=firingForce,
