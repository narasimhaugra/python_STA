...
Updated on 21-October-2024, by Ugra Narasimha : DV Protocols Development """
import OLEDRecordingThread
from Serial_Relay_Control import serialControl


def EEADVRecoveryMode_460333(json_data, NCDComPort,
    ...
    EEA_DV_Recovery_Mode_460333(serialControlObj, videoPath, itr, passed_executions)
    serialControlObj.disconnectSerialConnection()


# Purpose-To perform Normal Firing Scenarios
def EEA_DV_Recovery_Mode_460333(serialControlObj, videoPath, itr, passed_executions):
    success_flag = True
    ...
    # Step - 5.1.4.	Confirm handle indicates that adapter is ready to accept PEEA reload
    ...
    for i in range(total_firings):
        ...
        # Firing Test
        serialControlObj.DV_firing_460333(clampingForce=clampingForce, firingForce=firingForce,
