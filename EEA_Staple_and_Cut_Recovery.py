...
def T98_FiringRecovery_FiringRecoveryRequirements(r, SULU_EEPROM_command_byte, MULU_EEPROM_command_byte,
    ...
    print("-----------------EEA Firing Recovery Requirements Case 1 -------------------")
    ...
    T98_Firing_Recovery_Firing_Recovery_Requirements(serialControlObj, EEA_RELOAD_EEPROM_command_byte, NCDComPort,
...
def T98_Firing_Recovery_Firing_Recovery_Requirements(serialControlObj, EEA_RELOAD_EEPROM_command_byte, NCDComPort,
                                                     PowerPackComPort, BlackBoxComPort, USB6351ComPort,
                                                     ArduinoUNOComPort,
                                                     FtdiUartComPort, OUTPUT_PATH, videoPath, p):
    ...
    '''
    ###################################################################################################################
    ## CASE 1: Firing Recovery - Stapling and Cut Recovery 
    ###################################################################################################################
    '''
    ...
    serialControlObj.Firing_Recovery_items_Test_Results = []
    serialControlObj.Firing_Recovery_items_Test_Results.append('Firing =' + str(1))
    ...
    if serialControlObj.r['Reload Type'] == "EEA":
        ...
        if serialControlObj.r['Ship cap Present'] == "Yes":
            ...
            serialControlObj.Firing_Recovery_items_Test_Results.append('EEA RELOAD Connected:' + result)
        ...
        print("Step: EEA Reload Connected")
        print(serialControlObj.Firing_Recovery_items_Test_Results)
        serialControlObj.wait(3)
        ...
        serialControlObj.Firing_Recovery_items_Test_Results.append('EEA Trocar Extention with Reload:' + result)
        ...
        serialControlObj.Firing_Recovery_items_Test_Results.append('EEA Clamping on Tissue:' + result)
        ...
        serialControlObj.Firing_Recovery_items_Test_Results.append('EEA Green Key Ack:' + result)
        ...
        Strings_to_Compare = locateStringsToCompareFromEvent('Remove Adapter When 1st EEA Stapling In Progress')
        result = Compare('Remove Adapter When 1st EEA Stapling In Progress', Strings_to_Compare, Strings_from_PowerPack)
        serialControlObj.Firing_Recovery_items_Test_Results.append('Recovery Adapter When 1st EEA Stapling In Progress:' + result)
        print("Step: Remove Adapter When 1st EEA Stapling In Progress")
        print(serialControlObj.Firing_Recovery_items_Test_Results)
        serialControlObj.wait(10)
        ...
        result = Compare('EEA Green Key Ack', Strings_to_Compare, Strings_from_PowerPack)
        serialControlObj.Firing_Recovery_items_Test_Results.append('EEA Green Key Ack:' + result)
        print("Step: Acknowledged Safety Key (Green LED) after Stapling In progress ")
        print(serialControlObj.Firing_Recovery_items_Test_Results)
        ...
        serialControlObj.Firing_Recovery_items_Test_Results.append('Remove Adapter When Cutting Starts:' + result)
        ...
        for item in serialControlObj.Test_Results:
            ...
            try:
                if (((str.split(item, ':', 1))[1]) == 'PASS'):
                    # serialControlObj.Test_Results.append(serialControlObj.Firing_Recovery_items_Test_Results[0] + ':FAIL')
                    pass
