...
def EEADVCutKnifeMissing_359465(json_data, NCDComPort,
    ...
    EEA_DV_Cut_Knife_Missing_359465(serialControlObj, videoPath, itr, passed_executions)
    serialControlObj.disconnectSerialConnection()


# Purpose-To perform Normal Firing Scenarios
def EEA_DV_Cut_Knife_Missing_359465(serialControlObj, videoPath, itr, passed_executions):
    success_flag = True
    ...
    for i in range(total_firings):
        ...
        # Firing Test
        serialControlObj.DV_Knife_Missing_359465(clampingForce=clampingForce, firingForce=firingForce,
