...
def FailuretoIncrement1Wcounter_FiringRecoveryRequirements(json_data, NCDComPort,
    ...
    Failure_to_Increment_1W_counter_Firing_Recovery_Requirements(serialControlObj, videoPath, itr,
...
def Failure_to_Increment_1W_counter_Firing_Recovery_Requirements(serialControlObj, videoPath, itr,
                                                                 passed_executions, PowerPackComPort, NCDComPort):
    success_flag = True
    ...
    # print("AdapterEEPROMProcedureCount : , AdapterEEPROMFireCount : ", AdapterEEPROMProcedureCount,
    #       AdapterEEPROMFireCount)
    ...
    for i in range(total_firings):
        ...
        # Firing Test
        serialControlObj.increment_1w_counter_failuer_test(clampingForce=clampingForce, firingForce=firingForce,
